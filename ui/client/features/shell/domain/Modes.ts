...
// routes to a screen. "Plan" is the label on the button (the rename of Research, #243) and it leads to the
// Plan screen (`/plan`, #289). The Dashboard's research form stays a screen of this mode, and the
// `construct research` CLI verb and `[Research]` ticket titles are unchanged. The mode's design lives in
// docs/design/cockpit-layout.md section 4 (`plan-mode`); Review (#312) is a fourth mode that fills all
// three panes (docs/design/mocks/pr-review-*.html).
...
export const MODES: ShellMode[] = [
  ...
  { id: 'plan', label: 'Plan', href: '/plan', activeOn: ['/plan', '/', '/dashboard'] },
