...
test('nothing here can reach a model or the network: only sibling modules are imported and no client is used', () => {
  ...
  assert.deepEqual(imports, ['./block-flows.mjs', './chooser.mjs', './config.mjs', './generators.mjs', './plan.mjs', './proof.mjs', './requirement-card.mjs', './shape-source.mjs', './shapes.mjs', './wiring.mjs']);
