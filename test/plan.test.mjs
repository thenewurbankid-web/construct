...
const EVERY_FLOW_STEPS = [
  ...
  {
    id: 's-handler', title: 'Serve GET /api/totals', flow: 'create.handler', executor: 'deterministic',
    args: { name: 'Totals', feature: 'checkout', method: 'GET', path: '/api/totals', service: 'Totals', entity: 'Total', fields: 'id:string,name:string' }, dependsOn: ['s-store'],
    touches: touching('checkout', 'app/api/totals/route.ts', 'create', 'route'),
  },
  {
