...
export const USER_GROUPS = [
  ...
  },
  {
    ...
    pages: [
      { path: 'user-guide/how-to/create/', title: 'Create features, layers and services', description: 'Scaffold in the right place, in the right order.', file: C('user/create.md') },
