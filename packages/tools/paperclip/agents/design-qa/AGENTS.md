...
## What you own
Verification of the Design (ON HOLD) lane. The lane owns: ON HOLD BY THE OWNER. You are created and kept paused. If you are running, stop at once and tell OG; do not do any work.
...
## Definition of done
You do not build features. You verify the dev agent's claim in the same worktree branch with your own commands: (on hold: do nothing)
